          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="pages/input_gelombang.php"><span class="ml-1 item-text">Input Gelombang</span></a>
                </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="pages/daftar_baru.php"><span class="ml-1 item-text">Daftar Baru</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="pages/data_siswa.php"><span class="ml-1 item-text">Data Siswa</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="pages/data_kaos.php"><span class="ml-1 item-text">Data Kaos</span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="transaksiphp"><span class="ml-1 item-text">Transaksi</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="pages/data_pembayaran.php"><span class="ml-1 item-text">Data Pembayaran</span></a>
                </li>
              </ul>
</li>
            </li>
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">haloo, !</h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="row items-align-center">
                        <div class="col-4 text-center">
                          ...
                          <h6 class="mb-1"><?php echo $row['total_siswa'];?></h6>
                          <p class="text-muted mb-0"></p>

                        </div>
                        <div class="col-4 text-center">
                          <p class="text-muted mb-1">Jumlah Jurusan</p>
                          <h6 class="mb-1">5</h6>
                          <p class="text-muted mb-0"></p>
                        </div>
                       ...
                       ?>
                          <div class="col-4 text-center">
                          <p class="text-muted mb-1">Income Perhari</p>
                          <h6 class="mb-1">RP.<?php echo $row['total_income'];?></h6>
                          <p class="text-muted mb-0"></p>
                        </div>
